...
const FR = {
  ...
  // — Dé rapide, tickets de bus, cases de la Mega Edition ——
  speedDie: 'Dé rapide',
  speedDieMrMonopoly: 'Mr Monopoly',
  speedDieBus: 'Bus',
  busTickets: 'Tickets de bus',
  busTicketExpires: 'périme tous les autres',
  useBusTicket: 'Prendre le car',
  useBusTicketInstead: 'Prendre le car au lieu de lancer',
  takeBusTicket: 'Prendre un ticket',
  busChoiceTitle: 'Le dé rapide affiche le Bus.',
  busPoolLeft: (n) => `${n} ticket(s) encore en pioche`,
  chooseSpaceTriple: 'Triple identique ! Posez votre pion où vous voulez.',
  chooseSpaceBus: 'Où descendez-vous ? (ce côté du plateau, devant vous)',
  chooseSpaceAuction: 'Quelle propriété de la banque mettez-vous en vente ?',
  chooseSpaceGo: 'Y aller',
  ...
  needMajority: (need, size) => `Il faut ${need} propriétés sur ${size} pour construire`,
  needCrownedGroup: 'Il faut le groupe entier, avec un hôtel sur chaque case',
...
const EN = {
  ...
  busTicketExpires: 'expires all the others',
  useBusTicket: 'Catch the coach',
  useBusTicketInstead: 'Catch the coach instead of rolling',
  takeBusTicket: 'Take a ticket',
  busChoiceTitle: 'The Speed Die shows the Bus.',
  busPoolLeft: (n) => `${n} ticket(s) left in the pile`,
  chooseSpaceTriple: 'Triple! Put your token anywhere on the board.',
  chooseSpaceBus: 'Where do you get off? (this side of the board, ahead of you)',
  chooseSpaceAuction: "Which of the bank's properties do you put up for sale?",
  chooseSpaceGo: 'Go there',
  ...
  needMajority: (need, size) => `You need ${need} of the ${size} properties to build`,
  needCrownedGroup: 'You need the whole group, with a hotel on every space',
  yourCash: 'Your cash',
  undo: 'Undo',
